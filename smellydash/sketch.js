...
const LOCATION = {
  ...
  LEFT_ROCKET_CLOSE_LINE_UP: new Location("LEFT_ROCKET_CLOSE_LINE_UP", 3.97, 13.29, 118.75),
  RIGHT_ROCKET_CLOSE_LINE_UP: new Location("RIGHT_ROCKET_CLOSE_LINE_UP", 23.03, 13.29, 61.25),
  LEFT_ROCKET_MIDDLE_LINE_UP: new Location("LEFT_ROCKET_MIDDLE_LINE_UP", 7.33, 19.0, 180),
  RIGHT_ROCKET_MIDDLE_LINE_UP: new Location("RIGHT_ROCKET_MIDDLE_LINE_UP", 19.67, 19.0, 0),
  LEFT_ROCKET_FAR_LINE_UP: new Location("LEFT_ROCKET_FAR_LINE_UP", 4.09, 24.93, -118.75),
  LEFT_ROCKET_FAR_LINE_UP_NEW: new Location("LEFT_ROCKET_FAR_LINE_UP_NEW", 2.97, 24.71, -118.75),
  RIGHT_ROCKET_FAR_LINE_UP: new Location("RIGHT_ROCKET_FAR_LINE_UP", 22.91, 24.93, -61.25),

  LEFT_ROCKET_CLOSE_DRIVER_SWITCH: new Location("LEFT_ROCKET_CLOSE_DRIVER_SWITCH", 3.12, 14.82, 118.75),
  RIGHT_ROCKET_CLOSE_DRIVER_SWITCH: new Location("RIGHT_ROCKET_CLOSE_DRIVER_SWITCH", 23.88, 14.82, 61.25),
  LEFT_ROCKET_MIDDLE_DRIVER_SWITCH: new Location("LEFT_ROCKET_MIDDLE_DRIVER_SWITCH", 5.58, 19.0, 180),
  RIGHT_ROCKET_MIDDLE_DRIVER_SWITCH: new Location("RIGHT_ROCKET_MIDDLE_DRIVER_SWITCH", 21.42, 19.0, 0),
  LEFT_ROCKET_FAR_DRIVER_SWITCH: new Location("LEFT_ROCKET_FAR_DRIVER_SWITCH", 3.12, 23.18, -118.75),
  RIGHT_ROCKET_FAR_DRIVER_SWITCH: new Location("RIGHT_ROCKET_FAR_DRIVER_SWITCH", 23.88, 23.18, -61.25),
  ...
  LEFT_LOADING_STATION_LINE_UP: new Location("LEFT_LOADING_STATION_LINE_UP", 6.97, 24.71, -90),
  RIGHT_LOADING_STATION_LINE_UP: new Location("RIGHT_LOADING_STATION_LINE_UP", 20.03, 24.71, -90),

  LEFT_LOADING_STATION_DRIVER_SWITCH: new Location("LEFT_LOADING_STATION_DRIVER_SWITCH", 2.23, 4.29, -90.0),
  RIGHT_LOADING_STATION_DRIVER_SWITCH: new Location("RIGHT_LOADING_STATION_DRIVER_SWITCH", 24.77, 4.29, -90.0),
