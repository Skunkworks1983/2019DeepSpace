...
public class Path
{
    public static final Path REVERSED_LEVEL_1_LEFT_TO_LEFT_ROCKET_FAR_LINE_UP = new Path(true, Pose.LEVEL_1_LEFT_REVERSED, Pose.LEFT_ROCKET_FAR_LINE_UP);
    public static final Path REVERSED_LEVEL_1_RIGHT_TO_RIGHT_ROCKET_FAR_LINE_UP = new Path(true, Pose.LEVEL_1_RIGHT_REVERSED, Pose.RIGHT_ROCKET_FAR_LINE_UP);
    ...
    public static final Path LEFT_ROCKET_FAR_TO_LEFT_LOADING_STATION_LINE_UP = new Path(true, Pose.LEFT_ROCKET_FAR, Pose.LEFT_LOADING_STATION_LINE_UP);
    public static final Path RIGHT_ROCKET_FAR_TO_RIGHT_LOADING_STATION_LINE_UP = new Path(true, Pose.RIGHT_ROCKET_FAR, Pose.RIGHT_LOADING_STATION_LINE_UP);

    public static final Path LEFT_LOADING_STATION_LINE_UP_TO_LEFT_LOADING_STATION_DRIVER_SWITCH = new Path(Pose.LEFT_LOADING_STATION_LINE_UP, Pose.LEFT_LOADING_STATION_DRIVER_SWITCH);
    public static final Path RIGHT_LOADING_STATION_LINE_UP_TO_RIGHT_LOADING_STATION_DRIVER_SWITCH = new Path(Pose.RIGHT_LOADING_STATION_LINE_UP, Pose.RIGHT_LOADING_STATION_DRIVER_SWITCH);

    public static final Path LEFT_LOADING_STATION_TO_LEFT_ROCKET_FAR_LINE_UP = new Path(true, Pose.LEFT_LOADING_STATION, new Pose(Pose.LEFT_ROCKET_MIDDLE.getPosition().getX() + 2, Pose.LEFT_ROCKET_MIDDLE.getPosition().getY() - 3, -90), Pose.LEFT_ROCKET_FAR_LINE_UP);
    public static final Path RIGHT_LOADING_STATION_TO_RIGHT_ROCKET_FAR_LINE_UP = new Path(true, Pose.RIGHT_LOADING_STATION, new Pose(Pose.RIGHT_ROCKET_MIDDLE.getPosition().getX() - 2, Pose.RIGHT_ROCKET_MIDDLE.getPosition().getY() - 3, -90), Pose.RIGHT_ROCKET_FAR_LINE_UP);
