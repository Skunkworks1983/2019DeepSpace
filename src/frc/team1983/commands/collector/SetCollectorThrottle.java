 ...
 */
public class SetCollectorThrottle extends Command
{
    private Collector collector;
    private double throttle;

    public SetCollectorThrottle(Collector collector, double throttle)
    {
        this.collector = collector;
        this.throttle = throttle;
    }

    public SetCollectorThrottle(double throttle)
    {
