...
public class RightRocketFarHatch extends CommandGroup
{
    public RightRocketFarHatch()
    {
        ...
        addSequential(new DrivePath(Path.REVERSED_LEVEL_1_RIGHT_TO_ROCKET_FAR_LINE_UP, 10));
...
//        addSequential(new DrivePath(Path.RIGHT_ROCKET_FAR_TO_LOADING_STATION_LINE_UP, 4));
//        addSequential(new DrivePath(Path.RIGHT_LOADING_STATION_LINE_UP_TO_DRIVER_SWITCH, 10));
//
//        // Driver hatch pickup
//        addSequential(new DriverSwitch());
//
//        addSequential(new DrivePath(Path.RIGHT_LOADING_STATION_TO_ROCKET_FAR_LINE_UP, 10));
