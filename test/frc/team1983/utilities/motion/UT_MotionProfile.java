...
public class UT_MotionProfile
{
    ...
    public void forwardTest()
    {
        ...
        assertThat(profile.evaluateVelocity(profile.getDuration() / 2), equalTo(500.0));
        assertThat(profile.evaluateVelocity(profile.getDuration()), equalTo(1000.0));

        assertThat(profile.evaluatePosition(0), equalTo(0.0));
        assertThat(profile.evaluatePosition(profile.getDuration() / 2), equalTo(100.0));
        assertThat(profile.evaluatePosition(profile.getDuration()), equalTo(0.0));
